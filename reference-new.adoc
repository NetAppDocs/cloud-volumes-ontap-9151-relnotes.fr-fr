...
Le patch 9.15.1 P14 est désormais disponible pour Cloud Volumes ONTAP pour tous les fournisseurs de cloud. La NetApp Console vous invitera à mettre à niveau vos systèmes existants vers cette version de correctif.
...
Le patch 9.15.1 P13 est désormais disponible pour Cloud Volumes ONTAP pour tous les fournisseurs de cloud. La NetApp Console vous invitera à mettre à niveau vos systèmes existants vers cette version de correctif.
